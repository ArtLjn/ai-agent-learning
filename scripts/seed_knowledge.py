...
KNOWLEDGE_DOCUMENTS: list[dict] = [
    {
        ...
        "source": "员工服务台内置种子",
        "content": (
            "新员工首日应确认员工号、钉钉组织关系、邮箱、SSO、VPN、工牌门禁、"
    ...
    },
    {
        ...
        "content": (
            ...
            "优先进入钉钉工作台的员工服务或制度中心，也可在 SSO 门户搜索制度名称。"
            "钉钉机器人只提供摘要和入口，最终口径以最新有效制度和归口部门答复为准。"
        ),
    },
    {
        ...
        "content": (
            ...
            "员工应提供员工号、加班日期、审批单号、考勤记录和补贴类型。服务台可核查"
            "同步状态，制度解释转 HR 或行政，金额和付款问题转财务。"
        ),
    },
    {
        ...
        "source": "员工服务台内置种子",
        "content": (
            "办公用品、软件许可证、SaaS 服务和固定资产采购应通过钉钉工作台或内部采购平台"
    ...
    },
    {
        ...
        "content": (
            ...
            "发票抬头、税号、金额、日期和附件必须符合财务制度。入口和材料问题可由"
    ...
    },
    {
        ...
        "source": "员工服务台内置种子",
        "content": (
            "钉钉员工咨询机器人可查询制度、定位系统入口、说明审批材料、创建工单和提醒补充信息。"
    ...
    },
    {
        ...
        "source": "员工服务台内置种子",
        "content": (
            "员工无法登录 SSO、邮箱、钉钉或业务系统时，应提供员工号、系统名称、报错截图和"
