...
> v2.2 模块归属：本文档设计的「人工审核工作台」归入**服务台处理端 / 人工审核模块**。详见 [00_预设计/02_系统功能与总体架构.md](../00_预设计/02_系统功能与总体架构.md) 第 4.2 节。
>
> 版本：v1.3
> 日期：2026-06-29
...
v2.2 起，审核工作台是服务台处理端的核心子模块，与工单受理、知识维护、运营分析并列。
...
- [12_Token成本控制台设计.md](./12_Token成本控制台设计.md) — 系统级 Token 成本统计，与开发人员工作台的运维观测能力衔接
