...
> 版本：v2.1
> 日期：2026-07-09
> 状态：扩展为双项目测试策略，覆盖 rag-service 独立项目、RAG Client 降级、Token 成本统计、决策点埋点修复、Prompt 版本管理
...
- **v2.1 对齐能力**：RAG Client 降级、Token 成本统计、Prompt 版本管理、rag-service 独立项目
...
- Token 用量累加、成本统计、Prompt 版本激活/回滚等管理员/开发人员操作行为符合契约
...
| 用户补充与双向沟通 | `waiting_user_input` 下提交补充消息；非该状态返回 409；空白消息返回 422 |
